...
class SearchController extends Controller
{
    public function index(Request $request)
    {
        return view('search', [
            ...
            'searchMode' => $request->get('searchMode', 'company'),
            'selectedJobTypeId' => $request->get('selectedJobTypeId'),
            'jobTypeCity' => $request->get('jobTypeCity'),
            'jobTypeState' => $request->get('jobTypeState')
        ]);
    }
}
