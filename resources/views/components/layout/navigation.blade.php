    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center">
                <a href="{{ route('home') }}" class="flex items-center space-x-3">
                    <img src="{{ asset('images/logos/logo.svg') }}" alt="WeSpeak Verify" class="h-12 w-auto">
            ...
            <div class="hidden md:flex items-center space-x-8">
                <a href="{{ route('home') }}"
                    class="text-gray-600 hover:text-blue-600 transition duration-200 {{ request()->routeIs('home') ? 'text-blue-600 font-medium' : '' }}">
                    Home
                </a>
                <a href="{{ route('how-it-works') }}"
                    class="text-gray-600 hover:text-blue-600 transition duration-200 {{ request()->routeIs('how-it-works') ? 'text-blue-600 font-medium' : '' }}">
                    How It Works
                </a>
                <a href="{{ route('pricing') }}"
                    class="text-gray-600 hover:text-blue-600 transition duration-200 {{ request()->routeIs('pricing') ? 'text-blue-600 font-medium' : '' }}">
                    Pricing
                </a>
            </div>
        ...
        <div class="md:hidden" x-data="{ mobileMenuOpen: false }" x-show="mobileMenuOpen" x-transition>
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-gray-200">
                ...
                <a href="{{ route('how-it-works') }}"
                    class="block px-3 py-2 text-gray-600 hover:text-blue-600 transition duration-200 {{ request()->routeIs('how-it-works') ? 'text-blue-600 font-medium' : '' }}">
                    How It Works
                </a>
                <a href="{{ route('pricing') }}"
                    class="block px-3 py-2 text-gray-600 hover:text-blue-600 transition duration-200 {{ request()->routeIs('pricing') ? 'text-blue-600 font-medium' : '' }}">
                    Pricing
                </a>
